...
Because Slack's page structure can change, the extension uses CSS selectors that target Slack's native message action toolbar. All behavior happens locally in the browser.
